...
<?php 
    ...
    $p=1;$ar=0;$next="contest_status.php?";$result;
	if(isset($_GET['page']))$p=$_GET['page'];
	$controller->get_statues($p,$ar,$next,$result);
	$next;
?>
<script>
  $(function() {
...
<div class="container">
  <form class="form-inline" role="form" action="<?php echo "contest_status.php?id={$_GET['id']}";?>" method="get">
