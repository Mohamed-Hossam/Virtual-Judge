...
<?php
	...
	function update_level_codeforces()
	{
		global $db;
	...
	function pcrawler_process_info($path,$baseurl,$space_deli=true,$cookie="")
	{
		global $pro;
	...
	function insert_problem($OJ="CodeForces")
	{
		global $db,$pro;
	...
	function update_problem($OJ="CodeForces")
	{
				global $db,$pro;
